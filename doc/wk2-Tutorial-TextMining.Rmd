...
nomin.list=read.csv("C:/Users/enriquethemoist/Dropbox/Columbia Work/4A - one/Applied Data Science/Project 1/fall2017-project1-enriquethemoist-master/wk2-TextMining/wk2-TextMining//data/nominlist.csv", stringsAsFactors = FALSE)

farewell.list=read.csv("C:/Users/enriquethemoist/Dropbox/Columbia Work/4A - one/Applied Data Science/Project 1/fall2017-project1-enriquethemoist-master/wk2-TextMining/wk2-TextMining/data/farewelllist.csv", stringsAsFactors = FALSE)
```
...
speech.url=speech.url[-(126), ] #cancel out Trump
...
writeLines(as.character(docs[[sample(1:nrow(corpus.list), 1)]])) #random sample
```
